...
int main(int argc, char** argv) {
    ...
    std::unordered_map<std::pair<char, char>, std::vector<unsigned int>, hash_pair> inverted_index = build_topk_inverted_index(gram_to_idx, lines);
    ...
    ind_out << "bigram," << NUM_INDEXED << "," << bit_index_building_time.count() << "," << bit_index_size << "," << inverted_index_building_time.count() << "," << inverted_index_size_fit << "," << inverted_index_size_max << std::endl;
    ind_out.close();
